  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<SettingsBloc, SettingsState>(
        ...
        if (state is InitialsSetState) return true;
        return false;
        ...
        return Column(
          children: [
            SettingsSwitch(
                name: 'DarkTheme'.tr(),
                initialValue: state.themeMode == ThemeMode.dark,
                onChanged: (bool value) {
                  settingsBloc.add(ToggleThemeEvent());
                  sharedPreferencesBloc.add(SaveEvent(
                      type: TypeEnum.boolean, value: value, key: 'darkTheme'));
                }),
            SettingsDropdown(
              name: 'FontSize'.tr(),
              onOptionSelected: (option) {
                ...
                sharedPreferencesBloc.add(SaveEvent(
                    type: TypeEnum.double, value: option, key: 'fontSize'));
              },
            ...
            SettingsDropdown(
              ...
              onOptionSelected: (option) {
                ...
                BlocProvider.of<ChatbotBloc>(context)
                  ..add(ChangeChatbotLocale(option));
                String _option;
